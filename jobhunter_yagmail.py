...
def delete_job(cursor, jobdetails):
    job_id = jobdetails['id']
    query = "DELETE FROM jobs WHERE Job_id = \"%s\"" % job_id  # This means if job ID matches it will delete the job https://www.tutorialspoint.com/mysql/mysql-delete-query.htm
    return query_sql(cursor, query)
        ...
        if is_job_found:
            ...
            if (now - job_date).days > 7:
                ...
                yag.send(to = 'pythonemailtest100@gmail.com',
                         ...
                         contents=("New job is found: " + "JobID: " + str(jobdetails['id'])+" "+ str(jobdetails['url'])))#https://mailtrap.io/blog/yagmail-tutorial/
